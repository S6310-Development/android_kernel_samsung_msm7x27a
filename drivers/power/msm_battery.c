...
#define pr_debug pr_info
	...
	defined(CONFIG_MACH_BAFFIN_DUOS_CTC) || defined(CONFIG_MACH_DELOS_OPEN) || defined(CONFIG_MACH_DELOS_DUOS_CTC)
...
#if defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_KYLEPLUS_OPEN)
...
#elif defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_KYLEPLUS_OPEN)|| defined(CONFIG_MACH_KYLEPLUS_CTC)
#define TOTAL_CHARGING_TIME		(6 * TIME_UNIT_HOUR)
...
#elif defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_KYLEPLUS_OPEN)
...
#define BATT_TEMP_HIGH_BLOCK_LPM  298
...
#define BATT_FULL_CHARGING_CURRENT	198		//  characteristic of FAN54013.
...
struct msm_battery_info {
	...
	u32 resume_flag;
	u32 boot_flag;
#if defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN)
...
#if defined(CONFIG_BQ27425_FUEL_GAUGE) || defined(CONFIG_MACH_ROY)|| defined(CONFIG_MACH_KYLEPLUS_CTC)
...
#endif /*CONFIG_MACH_GEIM*/
#if defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_INFINITE_DUOS_CTC)
				       ...
				       char *buf)
{
	...
	defined(CONFIG_BATTERY_STC3115)
	case FG_READ_SOC:
#if defined(CONFIG_MAX17043_FUELGAUGE) ||  defined(CONFIG_MAX17048_FUELGAUGE)  || defined(CONFIG_BATTERY_STC3115)
	...
	defined(CONFIG_BATTERY_STC3115) || defined(CONFIG_BQ27425_FUEL_GAUGE)
#if defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_KYLEPLUS_OPEN)
	case BATT_VOL_AVER:
#endif
		if (msm_batt_info.pdata &&
...
static void msm_batt_charge_fault(struct msm_battery_callback *ptr, int reason)
{
	...
	if (reason == FAN54013_FAULT_VBUS_OVP) {
...
static void msm_batt_charge_fault(struct msm_battery_callback *ptr, int reason)
{
	...
	if (reason == BQ24157_FAULT_VBUS_OVP) {
		pr_info("[BATT] %s: invalid charger\n", __func__);		
		queue_work(msm_batt_info.msm_batt_wq, &msm_batt_work);
	}
}
...
// temporary until REV02
	{	
		int charger_status = msm_batt_info.pdata->charger_ic->get_status();
		if (charger_status == 2) 
		{			
			pr_info("[BATT] %s: Fully charged\n", __func__);
			msm_batt_info.batt_full_check = 1;
...
#if defined(CONFIG_MAX17043_FUELGAUGE) || defined(CONFIG_MAX17048_FUELGAUGE) || defined(CONFIG_BATTERY_STC3115) || defined(CONFIG_BQ27425_FUEL_GAUGE)
...
#if !defined(_USE_BQ27425_TEMPERATURE) && \
	(defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_KYLEPLUS_OPEN)) 
...
#if defined(CONFIG_MACH_ARUBA_CTC) || defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_ROY) || defined(CONFIG_MACH_KYLEPLUS_CTC) || defined(CONFIG_MACH_KYLEPLUS_OPEN)	/* temperature split 1 degree unit */
...
static int msm_batt_get_batt_chg_status(void)
{
	...
	if (rc < 0) {
		...
		pr_debug("[BATT] %s: [v1p->] charger_status= %d, charger_type= %d, "
				...
				"batt_id= %d\n", 
				__func__, v1p->charger_status, v1p->charger_type,
				v1p->battery_status, v1p->battery_level, v1p->battery_voltage,
				v1p->battery_temp, v1p->battery_temp_adc, v1p->chg_current,
				v1p->batt_id);
...
static void msm_batt_update_psy_status(void)
{
	...
	defined(CONFIG_MAX17048_FUELGAUGE) || defined(CONFIG_BATTERY_STC3115)
