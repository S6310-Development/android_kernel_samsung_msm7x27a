...
static struct stc311x_platform_data stc3115_data = {
		...
		.CapDerating[6] = 260,   /* capacity derating in 0.1%, for temp = -20캜 */
  		.CapDerating[5] = 140,   /* capacity derating in 0.1%, for temp = -10캜 */
		.CapDerating[4] = 110,   /* capacity derating in 0.1%, for temp = 0캜 */
		.CapDerating[3] = 50,   /* capacity derating in 0.1%, for temp = 10캜 */
		.CapDerating[2] = 0,   /* capacity derating in 0.1%, for temp = 25캜 */
		.CapDerating[1] = -20,   /* capacity derating in 0.1%, for temp = 40캜 */
		.CapDerating[0] = -30,   /* capacity derating in 0.1%, for temp = 60캜 */
		...
		.OCVOffset2[0] = 0,     /* OCV curve adjustment */
  		...
  		.ExternalTemperature = Temperature_fn, /*External temperature fonction, return 캜*/
...
static struct stc311x_platform_data stc3115_data = {
		...
		.CapDerating[6] = 240,   /* capacity derating in 0.1%, for temp = -20째C */
  		.CapDerating[5] = 120,   /* capacity derating in 0.1%, for temp = -10째C */
		.CapDerating[4] = 90,   /* capacity derating in 0.1%, for temp = 0째C */
		.CapDerating[3] = 30,   /* capacity derating in 0.1%, for temp = 10째C */
		.CapDerating[2] = -20,   /* capacity derating in 0.1%, for temp = 25째C */
		.CapDerating[1] = -40,   /* capacity derating in 0.1%, for temp = 40째C */
		.CapDerating[0] = -50,   /* capacity derating in 0.1%, for temp = 60째C */
		...
		.OCVOffset2[0] = 0,     /* OCV curve adjustment */
			...
			/*if the application temperature data is preferred than the STC3115 temperature*/
  		.ExternalTemperature = Temperature_fn, /*External temperature fonction, return 째C*/
  		.ForceExternalTemperature = 0, /* 1=External temperature, 0=STC3115 temperature */
