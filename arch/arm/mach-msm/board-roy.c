...
=======
		...
		.CapDerating[3] = 50,   /* capacity derating in 0.1%, for temp = 10ï¿½C */
...
static struct stc311x_platform_data stc3115_data = {
		...
		.CapDerating[6] = 240,   /* capacity derating in 0.1%, for temp = -20Â°C */
  		.CapDerating[5] = 120,   /* capacity derating in 0.1%, for temp = -10Â°C */
		.CapDerating[4] = 90,   /* capacity derating in 0.1%, for temp = 0Â°C */
		.CapDerating[3] = 30,   /* capacity derating in 0.1%, for temp = 10Â°C */
		.CapDerating[2] = -20,   /* capacity derating in 0.1%, for temp = 25Â°C */
		.CapDerating[1] = -40,   /* capacity derating in 0.1%, for temp = 40Â°C */
		.CapDerating[0] = -50,   /* capacity derating in 0.1%, for temp = 60Â°C */
		...
		.OCVOffset2[0] = 0,     /* OCV curve adjustment */
			...
			/*if the application temperature data is preferred than the STC3115 temperature*/
  		.ExternalTemperature = Temperature_fn, /*External temperature fonction, return Â°C*/
  		.ForceExternalTemperature = 0, /* 1=External temperature, 0=STC3115 temperature */
